...
const products = [
  ...
  },
  {
    ...
    badge: 'Popular',
    fullDescription: 'Luxurious quilted budget organizer featuring diamond quilting pattern and rose gold snap closure. Perfect for keeping your budget categories organized in style with elegant compartments and sophisticated design.',
