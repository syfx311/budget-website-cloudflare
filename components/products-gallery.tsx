...
const products = [
  ...
  },
  {
    ...
    badge: 'Premium',
    fullDescription: 'Luxurious pink textured folding wallet with your custom name or initials beautifully embroidered inside. Perfect for personal use or as a thoughtful personalized gift. Features premium quality materials and sophisticated design.',
    colors: ['Rose Pink', 'Cream', 'Lavender'],
  },
  {
    id: 6,
