...
const products = [
  ...
  },
  {
    ...
    description: 'Beautiful motivational and aesthetic stickers for your budget setup',
    category: 'stickers',
    image: '/images/product-stickers.jpg',
    features: ['Motivational Quotes', 'Aesthetic Design', 'Premium Quality'],
    badge: 'Popular',
    fullDescription: 'High-quality decorative stickers featuring inspirational quotes and beautiful aesthetic designs to make your budget planning more enjoyable.',
    colors: ['Multi-Color', 'Rose Gold'],
  },
  {
    id: 1,
    title: 'Budget Envelope Inserts',
    description: 'Organize your savings with beautiful envelope-style inserts',
    category: 'stationery',
    image: '/images/product-budget-envelopes.jpg',
    features: ['Textured Design', 'Multiple Compartments', 'Aesthetic Appeal'],
    badge: 'New',
    fullDescription: 'Premium textured envelope inserts perfect for organizing your budget categories and savings goals in style.',
    colors: ['Taupe', 'Cream', 'Pink'],
  },
  {
    id: 5,
    title: 'Custom Budget Set',
    description: 'Complete luxury budget planning system with all essentials included',
    category: 'custom',
    image: '/images/product-custom-set.jpg',
    features: ['Complete System', 'Luxury Design', 'All-in-One Solution'],
    badge: 'Premium',
    fullDescription: 'Comprehensive custom budget set combining all our premium products with luxury aesthetic design and complete organizational tools.',
    colors: ['Rose Gold & Pink', 'Cream & Gold'],
  },
  {
    id: 6,
